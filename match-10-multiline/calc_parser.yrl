Nonterminals 
predicate literal expressions expression function_def argument_def arguments block.
...
predicate -> expressions: lists:flatten('$1').
...
block		-> open_block predicate close_block : {line('$1'), unwrap('$1'), '$2'}.
