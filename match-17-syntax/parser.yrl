...
open_block close_block integer float boolean endl atom string and_op xor_op or_op rtl ltr split_op.
...
list -> open_list bool_expr split_op bool_expr close_list: {cons, line('$1'), '$2', '$4'}.
...
atom_expr -> atom : {atom, line('$1'), unwrap('$1')}.
